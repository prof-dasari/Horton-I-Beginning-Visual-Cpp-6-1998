========================================================================
		ActiveX Control DLL : TRAFFICSIGNAL
========================================================================

ControlWizard has created this project for your TRAFFICSIGNAL ActiveX Control
...
that make up your TRAFFICSIGNAL ActiveX Control DLL.
...
TrafficSignalCtl.h
	This file contains the declaration of the CTrafficSignalCtrl C++ class.

TrafficSignalCtl.cpp
	This file contains the implementation of the CTrafficSignalCtrl C++ class.

TrafficSignalPpg.h
	This file contains the declaration of the CTrafficSignalPropPage C++ class.

TrafficSignalPpg.cpp
	This file contains the implementation of the CTrafficSignalPropPage C++ class.

TrafficSignalCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CTrafficSignalCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file TrafficSignal.rc.
